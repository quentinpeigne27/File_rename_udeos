...
#function for list files and directories in path of your choice
...
#function for create list of file
...
#function for remove filenames spaces           
...
#Call the function for list dir with -ld argument
if args.location and args.list_directory :
    list_dir(args.location)

#Call the function for rename file with -f and -nf arguments
...
#Call the function for sorts files
elif args.location and args.sort_file :
    sort_files(args.location)
    
#Call the function for remove filenames spaces
